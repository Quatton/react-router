...
function getHydrationData({
  ...
  let initialMatches = _chunkXLEPGZJ6js.matchRoutes.call(void 0, routes, location, basename);
  if (initialMatches) {
...
function RSCDefaultRootErrorBoundaryImpl({
  ...
  if (_chunkXLEPGZJ6js.isRouteErrorResponse.call(void 0, error)) {
    return /* @__PURE__ */ _react2.default.createElement(
      ...
      _chunkXLEPGZJ6js.ENABLE_DEV_WARNINGS ? heyDeveloper : null
    );
  }
  let errorInstance;
...
function RSCDefaultRootErrorBoundary({
  ...
  let error = _chunkXLEPGZJ6js.useRouteError.call(void 0, );
