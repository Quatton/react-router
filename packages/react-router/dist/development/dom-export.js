...
function HydratedRouter(props) {
  ...
  React2.useEffect(() => {
    if (process.env.NODE_ENV === "development" && criticalCss === void 0) {
      document.querySelectorAll(`[${_chunkXLEPGZJ6js.CRITICAL_CSS_DATA_ATTRIBUTE}]`).forEach((element) => element.remove());
    }
  }, [criticalCss]);
...
function createRouterFromPayload({
  ...
  _chunkVKBXFOSWjs.populateRSCRouteModules.call(void 0, globalVar.__reactRouterRouteModules, payload.matches);
  ...
  globalVar.__reactRouterDataRouter = _chunkXLEPGZJ6js.createRouter.call(void 0, {
    routes,
    getContext,
    basename: payload.basename,
    history: _chunkXLEPGZJ6js.createBrowserHistory.call(void 0, ),
    hydrationData: _chunkVKBXFOSWjs.getHydrationData.call(void 0, {
      state: {
      ...
      getRouteInfo: (routeId) => {
        ...
        _chunkXLEPGZJ6js.invariant.call(void 0, match, "Route not found in payload");
        return {
...
var renderedRoutesContext = _chunkXLEPGZJ6js.createContext.call(void 0, );
function getRSCSingleFetchDataStrategy(getRouter, ssr, basename, createFromReadableStream, fetchImplementation) {
  let dataStrategy = _chunkXLEPGZJ6js.getSingleFetchDataStrategyImpl.call(void 0, 
    getRouter,
    (match) => {
      let M = match;
      return {
...
function getFetchAndDecodeViaRSC(createFromReadableStream, fetchImplementation) {
  return async (args, basename, trailingSlashAware, targetRoutes) => {
    ...
    let url = _chunkXLEPGZJ6js.singleFetchUrl.call(void 0, request.url, basename, trailingSlashAware, "rsc");
    if (request.method === "GET") {
      url = _chunkXLEPGZJ6js.stripIndexParam.call(void 0, url);
      if (targetRoutes) {
        url.searchParams.set("_routes", targetRoutes.join(","));
      }
    }
    let res = await fetchImplementation(
      new Request(url, await _chunkXLEPGZJ6js.createRequestInit.call(void 0, request))
    );
    if (res.status >= 400 && !res.headers.has("X-Remix-Response")) {
      throw new (0, _chunkXLEPGZJ6js.ErrorResponseImpl)(res.status, res.statusText, await res.text());
    }
    _chunkXLEPGZJ6js.invariant.call(void 0, res.body, "No response body to decode");
    try {
      ...
      let results = { routes: {} };
      const dataKey = _chunkXLEPGZJ6js.isMutationMethod.call(void 0, request.method) ? "actionData" : "loaderData";
...
function RSCHydratedRouter({
  ...
  React3.useEffect(() => {
    _chunkXLEPGZJ6js.setIsHydrated.call(void 0, );
  }, []);
...
function createRouteFromServerManifest(match, payload) {
  ...
  _chunkXLEPGZJ6js.invariant.call(void 0, window.__reactRouterRouteModules);
  _chunkVKBXFOSWjs.populateRSCRouteModules.call(void 0, window.__reactRouterRouteModules, match);
  let dataRoute = {
    id: match.id,
    ...
    action: match.clientAction ? (args, singleFetch) => match.clientAction({
      ...
      throw _chunkXLEPGZJ6js.noActionDefinedError.call(void 0, "action", match.id);
    },
    path: match.path,
  ...
  if (typeof dataRoute.loader === "function") {
    dataRoute.loader.hydrate = _chunkXLEPGZJ6js.shouldHydrateRouteLoader.call(void 0, 
      match.id,
      match.clientLoader,
      match.hasLoader,
      false
...
function callSingleFetch(singleFetch) {
  _chunkXLEPGZJ6js.invariant.call(void 0, typeof singleFetch === "function", "Invalid singleFetch parameter");
  return singleFetch();
}
function preventInvalidServerHandlerCall(type, routeId, hasHandler) {
  if (!hasHandler) {
    ...
    console.error(msg);
    throw new (0, _chunkXLEPGZJ6js.ErrorResponseImpl)(400, "Bad Request", new Error(msg), true);
  }
}
...
function hasInvalidProtocol(location2) {
  try {
    return _chunkXLEPGZJ6js.invalidProtocols.includes(new URL(location2).protocol);
  } catch (e2) {
    return false;
  }
}
