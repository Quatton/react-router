...
function HydratedRouter(props) {
  ...
  React2.useEffect(() => {
    if (process.env.NODE_ENV === "development" && criticalCss === void 0) {
      document.querySelectorAll(`[${_chunkLIL6WPJZjs.CRITICAL_CSS_DATA_ATTRIBUTE}]`).forEach((element) => element.remove());
    }
  }, [criticalCss]);
...
function createRouterFromPayload({
  ...
  _chunk2FH64UNNjs.populateRSCRouteModules.call(void 0, globalVar.__reactRouterRouteModules, payload.matches);
  ...
  globalVar.__reactRouterDataRouter = _chunkLIL6WPJZjs.createRouter.call(void 0, {
    routes,
    getContext,
    basename: payload.basename,
    history: _chunkLIL6WPJZjs.createBrowserHistory.call(void 0, ),
    hydrationData: _chunk2FH64UNNjs.getHydrationData.call(void 0, {
      state: {
      ...
      getRouteInfo: (routeId) => {
        ...
        _chunkLIL6WPJZjs.invariant.call(void 0, match, "Route not found in payload");
        return {
...
var renderedRoutesContext = _chunkLIL6WPJZjs.createContext.call(void 0, );
function getRSCSingleFetchDataStrategy(getRouter, ssr, basename, createFromReadableStream, fetchImplementation) {
  let dataStrategy = _chunkLIL6WPJZjs.getSingleFetchDataStrategyImpl.call(void 0, 
    getRouter,
    (match) => {
      let M = match;
      return {
...
function getFetchAndDecodeViaRSC(createFromReadableStream, fetchImplementation) {
  return async (args, basename, trailingSlashAware, targetRoutes) => {
    ...
    let url = _chunkLIL6WPJZjs.singleFetchUrl.call(void 0, request.url, basename, trailingSlashAware, "rsc");
    if (request.method === "GET") {
      url = _chunkLIL6WPJZjs.stripIndexParam.call(void 0, url);
      if (targetRoutes) {
        url.searchParams.set("_routes", targetRoutes.join(","));
      }
    }
    let res = await fetchImplementation(
      new Request(url, await _chunkLIL6WPJZjs.createRequestInit.call(void 0, request))
    );
    if (res.status >= 400 && !res.headers.has("X-Remix-Response")) {
      throw new (0, _chunkLIL6WPJZjs.ErrorResponseImpl)(res.status, res.statusText, await res.text());
    }
    _chunkLIL6WPJZjs.invariant.call(void 0, res.body, "No response body to decode");
    try {
      ...
      let results = { routes: {} };
      const dataKey = _chunkLIL6WPJZjs.isMutationMethod.call(void 0, request.method) ? "actionData" : "loaderData";
...
function RSCHydratedRouter({
  ...
  React3.useEffect(() => {
    _chunkLIL6WPJZjs.setIsHydrated.call(void 0, );
  }, []);
  ...
  return /* @__PURE__ */ React3.createElement(_chunkLIL6WPJZjs.RSCRouterContext.Provider, { value: true }, /* @__PURE__ */ React3.createElement(_chunk2FH64UNNjs.RSCRouterGlobalErrorBoundary, { location: state.location }, /* @__PURE__ */ React3.createElement(_chunkLIL6WPJZjs.FrameworkContext.Provider, { value: frameworkContext }, /* @__PURE__ */ React3.createElement(
    _chunkLIL6WPJZjs.RouterProvider,
    {
...
function createRouteFromServerManifest(match, payload) {
  ...
  _chunkLIL6WPJZjs.invariant.call(void 0, window.__reactRouterRouteModules);
  _chunk2FH64UNNjs.populateRSCRouteModules.call(void 0, window.__reactRouterRouteModules, match);
  let dataRoute = {
    id: match.id,
    ...
    action: match.clientAction ? (args, singleFetch) => match.clientAction({
      ...
      throw _chunkLIL6WPJZjs.noActionDefinedError.call(void 0, "action", match.id);
    },
    path: match.path,
  ...
  if (typeof dataRoute.loader === "function") {
    dataRoute.loader.hydrate = _chunkLIL6WPJZjs.shouldHydrateRouteLoader.call(void 0, 
      match.id,
      match.clientLoader,
      match.hasLoader,
      false
...
function callSingleFetch(singleFetch) {
  _chunkLIL6WPJZjs.invariant.call(void 0, typeof singleFetch === "function", "Invalid singleFetch parameter");
  return singleFetch();
}
function preventInvalidServerHandlerCall(type, routeId, hasHandler) {
  if (!hasHandler) {
    ...
    console.error(msg);
    throw new (0, _chunkLIL6WPJZjs.ErrorResponseImpl)(400, "Bad Request", new Error(msg), true);
  }
}
...
function hasInvalidProtocol(location2) {
  try {
    return _chunkLIL6WPJZjs.invalidProtocols.includes(new URL(location2).protocol);
  } catch (e2) {
    return false;
  }
}
