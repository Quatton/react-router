...
function getHydrationData({
  ...
  let initialMatches = _chunkLIL6WPJZjs.matchRoutes.call(void 0, routes, location, basename);
  if (initialMatches) {
...
function RSCDefaultRootErrorBoundaryImpl({
  ...
  if (_chunkLIL6WPJZjs.isRouteErrorResponse.call(void 0, error)) {
    return /* @__PURE__ */ _react2.default.createElement(
      ...
      _chunkLIL6WPJZjs.ENABLE_DEV_WARNINGS ? heyDeveloper : null
    );
  }
  let errorInstance;
...
function RSCDefaultRootErrorBoundary({
  ...
  let error = _chunkLIL6WPJZjs.useRouteError.call(void 0, );
