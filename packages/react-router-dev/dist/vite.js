          ...
          ...ctx.reactRouterConfig.future.v8_viteEnvironmentApi ? {
            ...
            builder: {
              ...
              async buildApp(builder) {
                ...
                ctx.prerenderBuild = reactRouterConfig.prerender != null && reactRouterConfig.prerender !== false;
...
function isPrerenderingEnabled({
  ...
  return prerenderBuild && reactRouterConfig.prerender != null && reactRouterConfig.prerender !== false;
}
...
async function getEnvironmentOptionsResolvers(ctx, viteCommand) {
  ...
  function getBaseServerOptions({
    ...
    return mergeEnvironmentOptions(getBaseOptions({ viteUserConfig }), {
      define: {
        "process.env.IS_RR_BUILD_REQUEST": ctx.prerenderBuild ? '"yes"' : "undefined"
      },
      resolve: {
        external: (
